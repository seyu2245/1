!function(e, t) {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            t = n(5)(o),
            a += `<video muted loop="loop" autoplay="autoplay" src="https://bucket19911025video.oss-cn-hangzhou.aliyuncs.com/video/video_1.mp4" id="video_dom" class="dplayer-video dplayer-video-current">
            抱歉，您的浏览器不支持内嵌视频
        </video>`,
            a += "\n    ",
...
//         var lCHds_1 = new window["Date"]();
//         debugger;
//         if (new window["Date"]() - lCHds_1 > 10) {
